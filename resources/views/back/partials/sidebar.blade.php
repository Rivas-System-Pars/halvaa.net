    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                            ...
                            @can('users.create')
                                <li class="{{ active_class('admin.users.create') }}">
                                    <a href="{{ route('admin.users.create') }}"><i class="feather icon-circle"></i><span
                                            class="menu-item">ایجاد متوفی</span></a>
                                </li>
                            @endcan

                            @can('users.lifebio')
                                <li class="{{ active_class('admin.users.create') }}">
                                    <a href="{{ route('admin.users.info.lifebiography.create') }}"><i
                                            class="feather icon-circle"></i><span class="menu-item">زندگینامه</span></a>
                                </li>
                            @endcan

                            @can('users.lifecalender')
                                <li class="{{ active_class('admin.users.create') }}">
                                    <a href="{{ route('admin.users.info.lifecalender.create') }}"><i
                                            class="feather icon-circle"></i><span class="menu-item">گاهشمار زندگی</span></a>
                                </li>
                            @endcan

                            @can('users.Will')
                                <li class="{{ active_class('admin.users.create') }}">
                                    <a href="{{ route('admin.users.info.will.create') }}"><i
                                            class="feather icon-circle"></i><span class="menu-item">وصیتنامه</span></a>
                                </li>
                            @endcan

                            {{-- @can('users.memorial')
                       <li class="{{ active_class('admin.users.create') }}">
                           <a href="{{ route('admin.users.info.memorial.create') }}"><i class="feather icon-circle"></i><span
                                   class="menu-item">دفتریادبود</span></a>
                       </li>
                   @endcan --}}

                            @can('users.announcements')
                                <li class="{{ active_class('admin.users.create') }}">
                                    <a href="{{ route('admin.users.info.announcement.create') }}"><i
                                            class="feather icon-circle"></i><span class="menu-item">اطلاعیه ها</span></a>
                                </li>
                            @endcan
                            @can('users.notice')
                                <li class="{{ active_class('admin.users.create') }}">
                                    <a href="{{ route('admin.users.info.notice.create') }}"><i
                                            class="feather icon-circle"></i><span class="menu-item">اسناد هویت</span></a>
                                </li>
                            @endcan

                            @can('users.message')
                                <li class="{{ active_class('admin.users.create') }}">
                                    <a href="{{ route('admin.users.info.message.create') }}"><i
                                            class="feather icon-circle"></i><span class="menu-item">پیام مدیر آرامگاه</span></a>
                                </li>
                            @endcan

                            @can('user.verify')

                                <li class="{{ active_class('verification.create') }}">
                                    <a href="{{ route('admin.verification.create') }}"><i class="feather icon-circle"></i><span
                                            class="menu-item"> درخواست تایید متوفی </span></a>
                                </li>
                            @endcan

                            @can('user.banner')
                                <li class="{{ active_class('admin.users.create') }}">
                                    <a href="{{ route('admin.users.userbanner.create') }}">
                                        <i class="feather icon-circle"></i>
                                        <span class="menu-item">اپلود بنر و اعلامیه</span>
                                    </a>
                                </li>
                            @endcan
            ...
            @can('verification.manage')
                <li class="{{ active_class('admin.back.verification.index') }}">
                    <a href="{{ route('admin.back.verification.index') }}">
                        <i class="feather icon-file-text"></i>
                        <span class="menu-item">مدیریت درخواست متوفی‌ها</span>
                    </a>
                </li>
            @endcan
            ...
            @can('relatives')
                <li class="nav-item has-sub {{ open_class(['admin.relatives.*']) }}"><a href="#"><i
                            class="feather icon-user"></i><span class="menu-title"> نسبت ها</span></a>
                    <ul class="menu-content">
                        @can('relatives.index')
                            <li class="{{ active_class('admin.relatives.index') }}">
                                <a href="{{ route('admin.relatives.index') }}"><i class="feather icon-list"></i><span
                                        class="menu-item">لیست نسبت ها</span></a>
                            </li>
                        @endcan

                        @can('relatives.create')
                            <li class="{{ active_class('admin.relatives.create') }}">
                                <a href="{{ route('admin.relatives.create') }}"><i class="feather icon-user-plus"></i><span
                                        class="menu-item">ایجاد نسبت</span></a>
                            </li>
                        @endcan
            ...
            @can('familytree')
                <li class="{{ active_class('admin.familytree.create') }} nav-item">
                    <a href="{{ route('admin.familytree.create') }}">
                        <i class="feather icon-image"></i>
                        <span class="menu-title"> اپلود شجره نامه</span>
                    </a>
                </li>
            @endcan

            @can('close-user')
            <li class="{{ active_class('admin.close-user.create') }} nav-item">
                <a href="{{ route('admin.close-user.create') }}">
                    <i class="feather icon-heart"></i>
                    <span class="menu-title">افراد نزدیک</span>
                </a>
            </li>
        @endcan
            ...
            @can('relics')
                <li class="{{ active_class('admin.relics.create') }} nav-item">
                    <a href="{{ route('admin.relics.create') }}">
                        <i class="feather icon-image"></i>
                        <span class="menu-title"> آثار و لوازم </span>
                    </a>
                </li>
            @endcan
            {{--
            ...
            @can('themes')
                <li class="nav-item has-sub {{ open_class(['admin.themes.*', 'admin.widgets.*']) }}"><a href="#"><i
                            class="feather icon-layout"></i><span class="menu-title">قالب </span></a>
                    <ul class="menu-content">
                        @can('themes.index')
                        ...
                        @can('themes.settings')
                            @if (config('front.home-widgets'))
                                <li class="{{ active_class('admin.widgets.index') }}">
                                    <a href="{{ route('admin.widgets.index') }}"><i class="feather icon-circle"></i><span
                                            class="menu-item">مدیریت صفحه
                                            اصلی</span></a>
                                </li>
                            @endif
                        @endcan
        ...
        {{--
			...
			@endcan
			@can('demo-request')
			<li class="{{ active_class('admin.demo-request.*') }} nav-item"><a href="{{ route('admin.demo-request.index') }}">
                    <i class="feather icon-airplay"></i>
                    <span class="menu-title">درخواست‌های دمو آنلاین</span>
                </a>
            </li>
			@endcan
			@can('counseling-form')
			<li class="{{ active_class('admin.counseling-form.*') }} nav-item"><a href="{{ route('admin.counseling-form.index') }}">
                    ...
                    <span class="menu-title">مشاهده فرم خرید</span>
                </a>
            </li>
			@endcan
			--}}
