...
@section('content')
@php $discount_per_purchases = $product->discount_per_purchase; @endphp
                                            ...
                                            <ul class="nav nav-tabs nav-left flex-column" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="baseVerticalLeft-tab1"
                                                       data-toggle="tab" aria-controls="tabVerticalLeft1"
                                                       href="#tabVerticalLeft1" role="tab" aria-selected="true">اطلاعات
                                                        کلی</a>
                                                </li>
                                                <li class="nav-item">
                                                ...
                                                <li class="nav-item physical-item">
                                                    <a class="nav-link" id="product-prices-tab-nav" data-toggle="tab"
                                                       ...
                                                       role="tab" aria-selected="false">قیمت</a>
                                                </li>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6 col-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="type" id="product-type"
                                                                                class="form-control">
                                                                            <option
                                                                                value="physical" {{ $product->isPhysical() ? 'selected' : '' }}>
                                                                                محصول فیزیکی
                                                                            </option>
                                                                            <option
                                                                                value="download" {{ $product->isDownload() ? 'selected' : '' }}>
                                                                                محصول دانلودی
                                                                            </option>
                                                                        </select>
                                                                    </div>
                                                                ...
                                                                <div class="col-md-3 col-12">
                                                                    <div class="form-group">
                                                                        <label>انتشار در صفحه اصلی(شماره ترتیب)</label>
                                                                        <input type="text" class="form-control"
                                                                               name="publish_in_index" value="{{ $product->publish_in_index }}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                        ...
                                                                        <select name="currency_id" class="form-control">
                                                                            ...
                                                                            @foreach ($currencies as $currency)
                                                                                <option
                                                                                    ...
                                                                                    value="{{ $currency->id }}" {{ $product->currency && $product->currency->id == $currency->id ? 'selected' : '' }}>{{ $currency->title }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="rounding_amount"
                                                                            ...
                                                                            <option
                                                                                ...
                                                                                value="default" {{ $product->rounding_amount == "default" ? 'selected' : '' }}>
                                                                                پیشفرض
                                                                            </option>
                                                                            <option data-value="no"
                                                                                    value="no" {{ $product->rounding_amount == "no" ? 'selected' : '' }}>
                                                                                خیر
                                                                            </option>
                                                                            <option data-value="100"
                                                                                    value="100" {{ $product->rounding_amount == "100" ? 'selected' : '' }}>
                                                                                100 تومان
                                                                            </option>
                                                                            <option data-value="1000"
                                                                                    value="1000" {{ $product->rounding_amount == "1000" ? 'selected' : '' }}>
                                                                                1000 تومان
                                                                            </option>
                                                                            <option data-value="10000"
                                                                                    value="10000" {{ $product->rounding_amount == "10000" ? 'selected' : '' }}>
                                                                                10000 تومان
                                                                            </option>
                                                                            <option data-value="100000"
                                                                                    value="100000" {{ $product->rounding_amount == "100000" ? 'selected' : '' }}>
                                                                                100000 تومان
                                                                            </option>
                                                                        </select>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="rounding_type"
                                                                            ...
                                                                            <option
                                                                                ...
                                                                                value="default" {{ $product->rounding_type == 'default' ? 'selected' : '' }}>
                                                                                پیشفرض
                                                                            </option>
                                                                            <option data-value="close"
                                                                                    value="close" {{ $product->rounding_type == 'close' ? 'selected' : '' }}>
                                                                                نزدیک
                                                                            </option>
                                                                            <option data-value="up"
                                                                                    value="up" {{ $product->rounding_type == 'up' ? 'selected' : '' }}>
                                                                                رو به بالا
                                                                            </option>
                                                                            <option data-value="down"
                                                                                    value="down" {{ $product->rounding_type == 'down' ? 'selected' : '' }}>
                                                                                رو به پایین
                                                                            </option>
                                                                        </select>
                                                                    </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12 text-center mt-2">
                                                                    <button id="add-product-prices" type="button"
                                                                        ...
                                                                        <i class="feather icon-plus"></i> افزودن قیمت
                                                                    </button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12 text-center mt-2">
                                                                <button id="add-product-file" type="button"
                                                                        class="btn btn-outline-primary waves-effect waves-light">
                                                                    <i class="feather icon-plus"></i> افزودن فایل
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                        ...
                                                                        @foreach ($product->specificationGroups->unique() as $group)
                                                                            <div class="row mt-2 specification-group">
                                                                                            ...
                                                                                            <div class="row">
                                                                                                    ...
                                                                                                    <fieldset>
                                                                                                        <label>
                                                                                                            <input
                                                                                                                ...
                                                                                                                type="checkbox" {{ $specification->pivot->special ? 'checked' : '' }}>
                                                                                                        </label>
                                                                                                    </fieldset>
                                                                                                </div>
                                                                                                <div
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <textarea
                                                                                                        ...
                                                                                                        placeholder="مثال: 32 گیگابایت"
                                                                                                        required>{{ $specification->pivot->value }}</textarea>
                                                                                                </div>
                                                                                                <div class="col-md-1">
                                                                                                    <button
                                                                                                        type="button"
                                                                                                        class="btn btn-flat-danger waves-effect waves-light remove-specification custom-padding">
                                                                                ...
                                                                                <div class="col-md-12 text-center">
                                                                                    <button type="button"
                                                                                            class="btn btn-flat-success waves-effect waves-light add-specifaction">
                                                                                        افزودن مشخصات
                                                                                    </button>
                                                                                    <button type="button"
                                                                                            class="btn btn-flat-danger waves-effect waves-light remove-group">
                                                                                        حذف گروه
                                                                                    </button>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <p>
                                                                            <small>
                                                                                <a id="generate-product-slug" href="#">ایجاد
                                                                                    خودکار</a>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="dropzone dropzone-area mb-2"
                                                                         id="product-images">
                                                                        <div class="dz-message">تصاویر را به اینجا
                                                                            بکشید
                                                                        </div>
                                                                    </div>
                                                                </div>
                                    ...
                                    <div class="row p-0 mb-1">
                                        <div class="col-12">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <h5>جوایز برای خرید تعداد مشخص</h5>
                                                <button type="button" id="add-gift-per-purchase"
                                        ...
                                        <div class="gift-per-purchase-items col-12">
                                            @php
                                                $gifts = $product->gifts()->with('products:id,title')->get();
                                            @endphp
                                            @if($gifts->count())
                                                @foreach($gifts as $gift)
                                                    <div class="gift-per-purchase-product">
                                                        <div class="col-12 d-flex align-items-center">
                                                            <button type="button"
                                                                    data-destroy="{{ route('admin.product-gifts.destroy',$gift->id) }}"
                                                                    class="remove-gift-per-purchase border-0 bg-transparent">
                                                                <i class="vs-icon feather text-danger icon-x-circle"></i>
                                                            </button>
                                                            <input type="hidden"
                                                                   name="gift_products[{{ $loop->iteration }}][gift_id]"
                                                                   value="{{ $gift->id }}">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="controls">
                                                                            ...
                                                                            <input type="text"
                                                                                   ...
                                                                                   name="gift_products[{{ $loop->iteration }}][count]"
                                                                                   value="{{ $gift->quantity }}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <div class="controls">
                                                                            <label>محصولات</label>
                                                                            <select
                                                                                class="form-control gift-products"></select>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12 gift-per-purchase-products"
                                                             data-key="gift_products[{{ $loop->iteration }}]">
                                                            @php
                                                                $giftIteration=$loop->iteration;
                                                            @endphp
                                                            @if($gift->products->count())
                                                                @foreach($gift->products as $product)
                                                                    <div class="d-flex">
                                                                        <button type="button"
                                                                                data-destroy="{{ route('admin.product-gifts.products.detach',[$gift->id,$product->id]) }}"
                                                                                class="remove-gift-per-purchase-product border-0 bg-transparent">
                                                                            <i class="vs-icon feather text-danger icon-x-circle"></i>
                                                                        </button>
                                                                        <div class="row m-0 flex-grow-1"
                                                                             data-product="{{ $product->id }}">
                                                                            <div
                                                                                class="col-md-6 d-flex justify-content-start align-items-center">{{ $product->title }}</div>
                                                                            <input type="hidden"
                                                                                   name="gift_products[{{ $giftIteration }}][products][{{ $loop->iteration }}][product_id]"
                                                                                   value="{{ $product->id }}">
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <div class="controls">
                                                                                        <label>تعداد</label>
                                                                                        <input type="text"
                                                                                               name="gift_products[{{ $giftIteration }}][products][{{ $loop->iteration }}][quantity]"
                                ...
                                <div class="card-body">
                                    <div class="form-body">
                                        <div class="row p-0 mb-1">
                                            <div class="col-12">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <h5>تخفیف به ازای تعداد خرید</h5>
                                                    <button type="button" id="add-discount-per-purchase"
                                                            class="border-0 bg-transparent">
                                                        <i class="vs-icon feather icon-plus-square"></i>
                                                    </button>
                                                </div>
                                            ...
                                            <div class="discount-per-purchase-items col-12">
                                                @if($discount_per_purchases && count($discount_per_purchases))
                                                    @foreach($discount_per_purchases as $item)
                                                        <div class="col-12 d-flex align-items-center">
                                                            <button type="button"
                                                                    class="remove-discount-per-purchase border-0 bg-transparent">
                                                                <i class="vs-icon feather text-danger icon-x-circle"></i>
                                                            </button>
                                                            <div class="flex-grow-1 row m-0">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <div class="controls">
                                                                            ...
                                                                            <input type="text"
                                                                                   name="discount_per_purchase[{{ $loop->iteration }}][quantity]"
                                                                                   class="form-control valid"
                                                                                   value="{{ $item['quantity'] }}">
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <div class="controls">
                                                                            ...
                                                                            <input type="text"
                                                                                   name="discount_per_purchase[{{ $loop->iteration }}][discount_amount]"
                                                                                   class="form-control valid"
                                                            ...
                                                            <fieldset class="checkbox">
                                                                <div class="vs-checkbox-con vs-checkbox-primary">
                                                                    <input type="checkbox"
                                                                           name="discount_per_purchase[{{ $loop->iteration }}][is_percent]"
                                                                           value="1"
                                                                           @if(array_key_exists('is_percent',$item) && $item['is_percent']) checked @endif>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <fieldset class="checkbox">
                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                        <input type="checkbox"
                                                               name="special" {{ $product->special ? 'checked' : '' }}>
                                                        <span class="vs-checkbox">
                                                        <span class="vs-checkbox--check">
                                                            <i class="vs-icon feather icon-check"></i>
                                                        </span>
                                                ...
                                                <ul class="list-unstyled mb-0">
                                                        ...
                                                        <fieldset>
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" class="custom-control-input"
                                                                       name="published" id="customRadio1"
                                                    ...
                                                    <li class="d-inline-block mr-2">
                                                        <fieldset>
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" class="custom-control-input"
                                                                       name="published" id="customRadio2"
                                                                       value="0" {{ !$product->published ? 'checked' : '' }}>
                                                                <label class="custom-control-label" for="customRadio2">پیش
                                                                    نویس</label>
                                                            </div>
                                                        </fieldset>
                                                    </li>
...
@push('scripts')
    ...
    <script src="{{ asset('back/assets/js/pages/products/all.js') }}?v=6"></script>
    <script src="{{ asset('back/assets/js/pages/products/edit.js') }}?v=3"></script>
@endpush
