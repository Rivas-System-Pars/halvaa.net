                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                               name="title"
                                                                               value="{{ $copy_product ? $copy_product->title : '' }}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                               name="title_en"
                                                                               value="{{ $copy_product ? $copy_product->title_en : '' }}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                ...
                                                                <div class="col-md-6 col-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="type" id="product-type"
                                                                                class="form-control">
                                                                            <option
                                                                                value="physical" {{ $copy_product && ($copy_product->isPhysical()) ? 'selected' : '' }}>
                                                                                محصول فیزیکی
                                                                            </option>
                                                                            <option
                                                                                value="download" {{ $copy_product && ($copy_product->isDownload()) ? 'selected' : '' }}>
                                                                                محصول دانلودی
                                                                            </option>
                                                                        </select>
                                                                    </div>
                                                                ...
                                                                <div class="col-md-3 col-12 physical-item">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number" class="form-control"
                                                                               name="weight"
                                                                               value="{{ $copy_product ? $copy_product->weight : '' }}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3 col-12 physical-item">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                               name="unit"
                                                                               value="{{ $copy_product ? $copy_product->unit : null }}">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-3 col-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                               name="publish_in_index" value="{{ $copy_product ? $copy_product->publish_in_index : null}}">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <fieldset class="form-group">
                                                                        ...
                                                                        <input type="text" name="labels"
                                                                               ...
                                                                               value="{{ $copy_product ? $copy_product->getLabels() : '' }}">
                                                                    </fieldset>
                                                                </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea class="form-control"
                                                                                  ...
                                                                                  rows="3">{{ $copy_product ? $copy_product->short_description : '' }}</textarea>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea id="description" class="form-control"
                                                                                  rows="3"
                                                                                  name="description">{{ $copy_product ? $copy_product->description : '' }}</textarea>
                                                                    </div>
                                                                </div>
                                                                        ...
                                                                        <select name="currency_id" class="form-control">
                                                                            ...
                                                                            @foreach ($currencies as $currency)
                                                                                <option
                                                                                    ...
                                                                                    value="{{ $currency->id }}" {{ $copy_product  ? ($copy_product->currency && $copy_product->currency->id == $currency->id ? 'selected' : '') : (option('default_currency_id') == $currency->id ? 'selected' : '') }}>{{ $currency->title }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="rounding_amount"
                                                                            ...
                                                                            <option
                                                                                ...
                                                                                value="default" {{ $copy_product && $copy_product->rounding_amount == "default" ? 'selected' : '' }}>
                                                                                پیشفرض
                                                                            </option>
                                                                            <option data-value="no"
                                                                                    value="no" {{ $copy_product && $copy_product->rounding_amount == "no" ? 'selected' : '' }}>
                                                                                خیر
                                                                            </option>
                                                                            <option data-value="100"
                                                                                    value="100" {{ $copy_product && $copy_product->rounding_amount == "100" ? 'selected' : '' }}>
                                                                                100 تومان
                                                                            </option>
                                                                            <option data-value="1000"
                                                                                    value="1000" {{ $copy_product && $copy_product->rounding_amount == "1000" ? 'selected' : '' }}>
                                                                                1000 تومان
                                                                            </option>
                                                                            <option data-value="10000"
                                                                                    value="10000" {{ $copy_product && $copy_product->rounding_amount == "10000" ? 'selected' : '' }}>
                                                                                10000 تومان
                                                                            </option>
                                                                            <option data-value="100000"
                                                                                    value="100000" {{ $copy_product && $copy_product->rounding_amount == "100000" ? 'selected' : '' }}>
                                                                                100000 تومان
                                                                            </option>
                                                                        </select>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="rounding_type"
                                                                            ...
                                                                            <option
                                                                                ...
                                                                                value="default" {{ $copy_product && $copy_product->rounding_type == 'default' ? 'selected' : '' }}>
                                                                                پیشفرض
                                                                            </option>
                                                                            <option data-value="close"
                                                                                    value="close" {{ $copy_product && $copy_product->rounding_type == 'close' ? 'selected' : '' }}>
                                                                                نزدیک
                                                                            </option>
                                                                            <option data-value="up"
                                                                                    value="up" {{ $copy_product && $copy_product->rounding_type == 'up' ? 'selected' : '' }}>
                                                                                رو به بالا
                                                                            </option>
                                                                            <option data-value="down"
                                                                                    value="down" {{ $copy_product && $copy_product->rounding_type == 'down' ? 'selected' : '' }}>
                                                                                رو به پایین
                                                                            </option>
                                                                        </select>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input id="specifications_type"
                                                                                   ...
                                                                                   value="{{ ($copy_product && $copy_product->specType) ? $copy_product->specType->name : '' }}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div id="specifications-area">
                                                                        @if ($copy_product)
                                                                            @foreach ($copy_product->specificationGroups->unique() as $group)
                                                                                <div
                                                                                    class="row mt-2 specification-group">
                                                                                    <div class="col-12">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                               name="meta_title"
                                                                               value="{{ $copy_product ? $copy_product->meta_title : '' }}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input id="slug" type="text"
                                                                               ...
                                                                               value="{{ $copy_product ? $copy_product->slug : '' }}">
                                                                        <p>
                                                                            <small>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea class="form-control"
                                                                                  ...
                                                                                  rows="3">{{ $copy_product ? $copy_product->meta_description : '' }}</textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <fieldset class="form-group">
                                                                        ...
                                                                        <input type="text" name="tags"
                                                                               ...
                                                                               value="{{ $copy_product ? $copy_product->getTags : '' }}">
                                                                    </fieldset>
                                                                </div>
                            ...
                            <div class="card-body">
                                <div class="form-body">
                                    <div class="row p-0 mb-1">
                                        ...
                                        <div class="gift-per-purchase-items col-12"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="form-body">
                                    <div class="row p-0 mb-1">
                                        ...
                                        <div class="discount-per-purchase-items col-12"></div>
                                    </div>
                                            ...
                                            <ul class="list-unstyled mb-0">
                                                    ...
                                                    <fieldset>
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input"
                                                                   name="published" id="customRadio1" value="1"
                                                                   checked="">
                                                ...
                                                <li class="d-inline-block mr-2">
                                                    <fieldset>
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input"
                                                                   name="published" id="customRadio2" value="0">
...
@push('scripts')
    ...
    <script src="{{ asset('back/assets/js/pages/products/create.js') }}?v=2"></script>
@endpush
