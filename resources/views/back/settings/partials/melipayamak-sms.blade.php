		...
		<div class="col-md-6">
            <div class="row">
                <div class="col-md-12 form-group mb-0">
                    <label>کد متن اقساط</label>
                    <div class="input-group mb-75">
                        <input type="text" name="installaments_pattern_code_melipayamak" class="form-control ltr sms_on_installaments" value="{{ option('installaments_pattern_code_melipayamak') }}" required>
                    </div>
                </div>
                <div class="col-md-12 form-group">
                    <label>متن نمونه ایجاد پترن</label>
                    <textarea readonly class="form-control sms_on_installaments" rows="4">{0} عزیز خوش آمدید. &#13;&#10 {{ option('info_site_title') }}</textarea>
                </div>
            </div>
        </div>
