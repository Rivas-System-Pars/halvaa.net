                        ...
                        <div id="main-card" class="card-content">
                            <div class="card-body">
                                <div class="tab-content">
                                    ...
                                    @php
                                        $gateway = $gateways->where('key', 'sina_bank')->first();
                                    @endphp
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <fieldset class="checkbox">
                                                <div class="vs-checkbox-con vs-checkbox-primary">
                                                    <input data-class="sina_bank" type="checkbox" name="gateways[{{ $gateway->id }}][is_active]" {{ $gateway->is_active ? 'checked' : '' }} >
                                                    <span class="vs-checkbox">
                                                        <span class="vs-checkbox--check">
                                                            <i class="vs-icon feather icon-check"></i>
                                                        </span>
                                                    </span>
                                                    <span class="">درگاه بانک سینا</span>
                                                </div>
                                            </fieldset>
                                        </div>
                                        <div class="col-md-2 form-group">
                                            ...
                                            <div class="input-group mb-75">
                                                <input type="number" name="gateways[{{ $gateway->id }}][ordering]" class="form-control ltr sina_bank"
                                        ...
                                        <div class="col-md-4 form-group">
                                            <label>عنوان</label>
                                            <div class="input-group mb-75">
                                                <input type="text" name="gateways[{{ $gateway->id }}][name]" class="form-control sina_bank" value="{{ $gateway->name }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4 form-group">
                                            <label>PIN code</label>
                                            <div class="input-group mb-75">
                                                <input type="text" name="gateways[{{ $gateway->id }}][configs][pin]" class="form-control ltr sina_bank" value="{{ $gateway->config('merchantId') }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <div class="input-group mb-75">
                                                <input type="text" name="gateways[{{ $gateway->id }}][configs][terminalId]" class="form-control ltr sina_bank" value="{{ $gateway->config('pin') }}" required>
                                            </div>
                                        </div>
                                    ...
                                    <hr>
										...
										@php
                                            $gateway = $gateways->where('key', 'aqayepardakht')->first();
                                        @endphp
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                <fieldset class="checkbox">
                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                        <input data-class="aqayepardakht" type="checkbox" name="gateways[{{ $gateway->id }}][is_active]" {{ $gateway->is_active ? 'checked' : '' }} >
                                                        <span class="vs-checkbox">
                                                            <span class="vs-checkbox--check">
                                                                <i class="vs-icon feather icon-check"></i>
                                                            </span>
                                                        </span>
                                                        <span class="">درگاه آقای پرداخت</span>
                                                    </div>
                                                </fieldset>
                                            </div>
                                            <div class="col-md-2 form-group">
                                                <label>ترتیب نمایش</label>
                                                <div class="input-group mb-75">
                                                    <input type="number" name="gateways[{{ $gateway->id }}][ordering]" class="form-control ltr aqayepardakht"
                                                           value="{{ $gateway->ordering }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4 form-group">
                                                <label>عنوان</label>
                                                <div class="input-group mb-75">
                                                    <input type="text" name="gateways[{{ $gateway->id }}][name]" class="form-control aqayepardakht" value="{{ $gateway->name }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4 form-group">
                                                <label>api کد</label>
                                                <div class="input-group mb-75">
                                                    <input type="text" name="gateways[{{ $gateway->id }}][configs][merchantId]" class="form-control ltr aqayepardakht" value="{{ $gateway->config('merchantId') }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4 form-group">
                                                <label>کد pin</label>
                                                <div class="input-group mb-75">
                                                    <input type="text" name="gateways[{{ $gateway->id }}][configs][pin]" class="form-control ltr aqayepardakht" value="{{ $gateway->config('pin') }}" required>
                                                </div>
                                            </div>
