...
@section('content')
    <div class="container mt-1 p-0 print-border">
        <div class="row" dir="rtl">
			...
			<div class="col-12">
				<div class="px-1">اقساط</div>
				<table class="table mb-2 print-border-top">
                    <thead>
                        <tr class="print-factor factor-table-color">
                            <th class="border-0" scope="col">ردیف</th>
                            <th class="border-0" scope="col">مبلغ</th>
                            <th class="border-0" scope="col">کارمزد</th>
                            <th class="border-0" scope="col">مجموع مبلغ</th>
                            <th class="border-0" scope="col">زمان پرداخت</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach($order->installment->items as $item)
                            <tr>
                                <th class="" scope="row">{{ $loop->iteration }}</th>
								<th>{{ number_format($item->amount)." تومان" }}</th>
								<th>{{ number_format($item->fee)." تومان" }}</th>
								<th>{{ number_format($item->getTotalAmount())." تومان" }}</th>
								<th>{{ jdate($item->date)->format('%d %B %Y') }}</th>
								<th></th>
                            </tr>
                        @endforeach
                    ...
                    <div class="col-4 pr-0">
                        <table class="table">
                            <tbody>
								...
								@if($order->installment)
								<tr>
                                    <th class="p-0">پیش قسط:</th>
                                    <td class="p-0">{{ number_format($order->installment->prepayment) }} تومان</td>
                                </tr>
								@endif
                                <tr>
