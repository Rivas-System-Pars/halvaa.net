...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{ asset('back/app-assets/vendors/css/forms/select/select2.min.css') }}">
    <link rel="stylesheet" type="text/css"
    ...
    <link type="text/css" rel="stylesheet" href="{{ asset('back/app-assets/css-rtl/jalalidatepicker.min.css') }}" />
...
<!-- Scripts -->
    <script>
        window.Laravel = {!! json_encode([
            'routes' => [
                'products'=>[
                    'publish'=>route('admin.products.published')
                ]
            ],
            'user' => auth()->user(),
...
<script src="{{ asset('back/app-assets/js/core/jalalidatepicker.min.js') }}"></script>
<!-- BEGIN Vendor JS-->
...
<script src="{{ asset('back/assets/js/scripts.js') }}?v=10"></script>
<!-- END: Theme JS-->
