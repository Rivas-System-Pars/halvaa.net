											...
											<tr id="brand-{{ $brand->id }}-tr">
                                                    ...
                                                    <td>
                                                        <span class="d-flex">
                                                            ...
                                                            @if (Route::has('front.brands.show') && $brand->slug)
                                                                <a href="{{ route('front.brands.show', $brand->slug) }}" target="_blank"><i class="feather icon-external-link ml-1"></i></a>
                                                            @endif
                                                        </span>
                                                    </td>
                                                    ...
                                                    <td class="text-center">
														@if($brand->slug)
                                                        <a href="{{ route('admin.brands.edit', $brand->slug) }}" class="btn btn-success mr-1 waves-effect waves-light">ویرایش</a>
														@endif
