...
<html lang="fa" dir="rtl">
  ...
  <body>
    <form action="<?php echo(isset($inputs['successUrl']) ? htmlentities($inputs['successUrl']) : '#') ?>" method="post" id="success_form">
	  <input type="hidden" name="_token" value="<?php echo csrf_token()?>">
	  </form>
    <form action="<?php echo(isset($inputs['cancelUrl']) ? htmlentities($inputs['cancelUrl']) : '#') ?>" method="post" id="cancel_form">
	  <input type="hidden" name="_token" value="<?php echo csrf_token()?>">
	  </form>
    <div class="container">
