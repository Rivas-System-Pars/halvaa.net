@switch($filter->filterable->type)
    ...
    @case('price')
        ...
        <div class="col-12 my-4 d-flex align-items-center justify-content-center flex-column gap-3">
            <div class="parent-switcher mb-3 w-100 d-flex align-items-center justify-content-between flex-row-reverse px-2">
                <label class="ui-statusswitcher d-flex align-items-center justify-content-center">
                    <input type="checkbox" id="switcher-price" class="price_filter" name="price_filter" {{ request('price_filter') ? 'checked' : '' }}>
                    <span class="ui-statusswitcher-slider">
                        <span class="ui-statusswitcher-slider-toggle"></span>
                    </span>
                </label>
                <label class="label-switcher m-0" for="switcher-price">فیلتر بر اساس قیمت: </label>
            </div>
            <div class="mt-2 mb-2 w-100 d-flex align-items-center justify-content-center px-2">
                <div id="slider-non-linear-step" class="w-100"></div>
            </div>
