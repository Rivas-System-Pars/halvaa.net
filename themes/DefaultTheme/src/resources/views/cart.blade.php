                    ...
                    <div class="col-xl-9 col-lg-8 col-md-12 col-sm-12 mb-2 px-0">
                        <nav class="tab-cart-page">
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">سبد خرید
                                                                ...
                                                                <div class="row list-row">
                                                                    ...
                                                                    <div class="col-4 col-sm-3 col-md-2 d-flex justify-content-center">
                                                                        <div class="counter-box">
                                                                            ...
                                                                            <input class="quantity cart_quantity count" min="{{ $product->isDownload() ? 1 : cart_min($price_to_stock) }}" name="product-{{ $product->pivot->id }}" max="{{ $product->isDownload() ? 1 : cart_max($price_to_stock) }}" value="{{ $product->pivot->quantity }}" type="number" data-minus-class="mdi mdi-minus" data-remove-class="mdi mdi-delete-outline" required>
                                                                    ...
                                                                    <div class="col-8 col-sm-9 col-md-3">
                                                                        <strong class="cart-product-price">{{ number_format($price_to_stock->discountPrice() * $product->pivot->quantity) }} <small>تومان</small></strong>

                                                                        @if($price_to_stock->discount)
                                                                            <del class="text-danger old-cart-product-price">{{ number_format($price_to_stock->tomanPrice() * $product->pivot->quantity) }} <small>تومان</small></del>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                            @endforeach
