                    ...
                    <div class="form-ui dt-sl dt-sn pt-4">
                        ...
                        <form id="login-with-code-form" data-redirect="{{ route('one-time-login', ['type' => 'login']) }}" action="{{ route('login-with-code.send') }}" method="POST">
                            ...
                            <div class="form-row with-icon form-group">
                                <input id="phone_number" type="text" name="phone_number" class="input-ui pr-2" placeholder="  شماره موبایل خود را وارد نمایید" value="">
                            ...
                            <div class="form-footer text-right mt-3">
                                <a href="{{ route('login') }}" class="d-inline-block mt-2">ورود با رمز عبور</a>
                            </div>

                            <div class="form-footer text-right mt-3">
                                <a href="{{ route('register') }}" class="d-inline-block mr-3 mt-2">ثبت نام آرامگاه جدید</a>
                            </div>

                            <div class="form-footer text-right mt-3">
                                <span class="d-block font-weight-bold">کاربر عادی هستید؟</span>
                                <a href="{{ url('user-register') }}" class="d-inline-block mr-3 mt-2">ثبت نام کاربرعادی</a>
                            </div>
